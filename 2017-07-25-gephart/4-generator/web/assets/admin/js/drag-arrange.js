...
(function (factory) {
  ...
  function getHoveredElement($clone, $dragElement, $movableElements) {
    ...
    var clonePaddingLeft = ($clone.outerWidth() - $clone.width()) / 2;
    var cloneHeight = $clone.height();
    var cloneLeftPosition = cloneOffset.left + clonePaddingLeft;
    var cloneRightPosition = cloneOffset.left + cloneWidth + clonePaddingLeft;
    ...
    for (var i = 0; i < $movableElements.length; i++) {
      ...
      horizontalMidPosition = offset.left + 0.5 * $currentElement.outerWidth() + clonePaddingLeft;
